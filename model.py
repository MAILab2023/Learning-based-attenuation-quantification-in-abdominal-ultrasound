...
class create_model(nn.Module):
    def __init__(self):
        ...
        self.layers1_1 = encoding_layers_1(0*2048)
        self.layers1_2 = encoding_layers_1(1*2048)
        self.layers1_3 = encoding_layers_1(2*2048)
        self.layers1_4 = encoding_layers_1(3*2048)
        self.layers1_5 = encoding_layers_1(4*2048)
        self.layers1_6 = encoding_layers_1(5*2048)
        self.layers1_7 = encoding_layers_1(6*2048)

        self.layers2 = encoding_layers_2()
    ...
    def forward(self, x, seg_info):
        l1_1 = self.layers1_1(x)
        l1_2 = self.layers1_2(x)
        l1_3 = self.layers1_3(x)
        l1_4 = self.layers1_4(x)
        l1_5 = self.layers1_5(x)
        l1_6 = self.layers1_6(x)
        l1_7 = self.layers1_7(x)

        l2_pre = self.concat((l1_1, l1_2, l1_3, l1_4, l1_5, l1_6, l1_7))

        l2 = self.layers2(l2_pre, seg_info)
